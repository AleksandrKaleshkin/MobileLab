package com.example.lab6_uchprack;
...
public class MainActivity extends Activity implements OnClickListener {
    ...
    final String LOG_TAG = "myLogs.db";
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnUpd:
                ...
                Log.d(LOG_TAG, "--- Update mytable: ---");       // подготовим значения для обновления       cv.put("name", name);       cv.put("email", email);       // обновляем по id
